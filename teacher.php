...
?>
<body>
<center><h1 style="font-size: 40px;">Enter Faculty Data</h1></center>
...
<div class="col-xs-6">
 ...
 <select name="branch" class="form-control" value="<?php echo($branch);?>">
  ...
  <select name="gender" class="form-control" value="<?php echo($gender);?>">
    ...
    <a href="http://localhost/sp/updateteacherdata.php"><button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
